...
region_summary <- barplot(region_summary_table[order(region_summary_table, decreasing = FALSE)],
                ...
                xlab = 'Region',
                ylab = 'Deaths')
text(region_summary,  + 200 , region_summary_table, font=1)
```
...
ggplot(data = police_post2015, aes(age)) + geom_histogram(binwidth = 5, color='black'  ,fill ='lightblue') + ggtitle("oof") +labs(x ='Age of Shooting Victim', y = 'Count of Victims')
```
...
ggplot(final_df, aes(race)) + geom_bar(aes(fill=Region) , position = "fill") + ggtitle("Normalized Stacked Bar Chart of Race and Region")
```
### Histograms of Age with Race Overlay

```{r}
#histogram of age with race underlay
ggplot(final_df, aes(age)) + geom_histogram(aes(fill=race), color="black", binwidth = 5) + ggtitle("Histogram of Age with Race Overlay") +labs( x = 'Age of Shooting Victim' , y='Count of Victims')
```

```{r}
#histogram of age with race underlay
ggplot(final_df, aes(age)) + geom_histogram(aes(fill=race), color="black", binwidth = 5, position = "fill") + ggtitle("Normalized Histogram of Age with Race Overlay") +labs( x = 'Age of Shooting Victim' , y='Count of Victims')
```
